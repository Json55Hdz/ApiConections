...
namespace SnowKore.Services
{
    public abstract class NewServiceData
    {
        ...
        private PopupData serviceFailedPopupData;
        ...
        {
            serviceFailedPopupData = new PopupData("Error", "Ha ocurrido un error intentando conectarte al server.\n " +
                "Por favor verifica tu conexión a internet.", () => Send(LastServiceResponse), null);
        }
